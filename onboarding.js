(() => {
  ...
  const copy = {
    pt: {
      ...
      "pricing.clinicTitle": "Medipath para clínicas e grupos médicos",
      "pricing.chooseProfile": "Escolha seu perfil",
      "pricing.doctorPlan": "Plano individual para médicos",
      "pricing.clinicAudience": "Para clínicas com múltiplos médicos",
      "pricing.doctorsTab": "Para médicos",
      "pricing.clinicsTab": "Para clínicas e grupos médicos",
      "pricing.clinicText": "Para clínicas, grupos de médicos ou equipes maiores, fale conosco para entendermos sua operação e apresentar a melhor configuração.",
      "pricing.clinicLink": "Falar agora",
      ...
      "success.title": "Seu acesso está a caminho.",
      "success.text": "Enviamos um e-mail para você criar sua senha e entrar no Medipath.AI. Se não chegar em alguns minutos, verifique também sua caixa de spam ou lixo eletrônico.",
      "success.home": "Voltar ao início",
      "success.guideTitle": "Conheça o Medipath.AI em 3 minutos.",
      "success.guideText": "Veja o guia de primeiros passos e comece já sabendo onde estão os principais recursos e como usar a plataforma.",
    ...
    en: {
      ...
      "pricing.clinicTitle": "Medipath for clinics and medical groups",
      "pricing.chooseProfile": "Choose your profile",
      "pricing.doctorPlan": "Individual plan for doctors",
      "pricing.clinicAudience": "For clinics with multiple doctors",
      "pricing.doctorsTab": "For doctors",
      "pricing.clinicsTab": "For clinics and medical groups",
      "pricing.clinicText": "For clinics, groups of doctors, or larger teams, talk to us so we can understand your operation and recommend the right setup.",
      "pricing.clinicLink": "Chat now",
      ...
      "success.title": "Your access is on its way.",
      "success.text": "We sent you an email to create your password and sign in to Medipath.AI. If it doesn't arrive within a few minutes, please also check your spam or junk folder.",
      "success.home": "Back to the top",
      "success.guideTitle": "Get to know Medipath.AI in 3 minutes.",
      "success.guideText": "Explore the getting started guide so you know where to find the main features and how to use the platform from the start.",
